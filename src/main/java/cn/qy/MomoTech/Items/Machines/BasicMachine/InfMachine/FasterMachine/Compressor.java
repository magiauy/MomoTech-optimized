...
public class Compressor extends AbstractFastMachine implements RecipeDisplayItem {
    public Compressor(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
