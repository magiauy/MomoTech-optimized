...
public class QuantityConstructor extends AbstractGUI implements RecipeDisplayItem {
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        it.add(bug5.clone());
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescription("quantity_constructor_pure_origin"), MomoTech.languageManager.getRecipeDescription("quantity_constructor_pure_origin_requirement")));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        it.add(creative_item_I.clone());
        it.add(creative__.clone());
        it.add(creative_item.clone());
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescription("quantity_constructor_final_item"), MomoTech.languageManager.getRecipeDescription("quantity_constructor_final_item_requirement")));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        it.add(final_star.clone());
        it.add(final_item.clone());
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescription("quantity_constructor_quantitative_plugin"), MomoTech.languageManager.getRecipeDescription("quantity_constructor_quantitative_plugin_requirement")));
        it.add(quantity_item.clone());
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescription("quantity_constructor_original_commandblock_common"), MomoTech.languageManager.getRecipeDescription("quantity_constructor_original_commandblock_common_requirement")));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        ...
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescription("quantity_constructor_original_commandblock_repeating"), MomoTech.languageManager.getRecipeDescription("quantity_constructor_original_commandblock_repeating_requirement")));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        ...
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescription("quantity_constructor_original_commandblock_chain"), MomoTech.languageManager.getRecipeDescription("quantity_constructor_original_commandblock_chain_requirement")));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        ...
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescription("quantity_constructor_concept_item"), MomoTech.languageManager.getRecipeDescription("quantity_constructor_concept_item_requirement")));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
