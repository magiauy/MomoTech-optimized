...
public class InfinityEntropyReconstructor extends AContainer implements RecipeDisplayItem {
    public InfinityEntropyReconstructor(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_INFINITY_ENTROPY_RECONSTRUCTOR";
    }
