...
public class Calculator extends AbstractGUI implements RecipeDisplayItem {
    public Calculator(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    protected void findNextRecipe(BlockMenu inv) {
        ...
        if ("MOMOTECH_DIGIT".equals(Slimefun.getItemDataService().getItemData(it1).orElseGet(()->"")))
            if ("MOMOTECH_DIGIT".equals(Slimefun.getItemDataService().getItemData(it3).orElseGet(()->""))){
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescriptionTitle("calculator"), MomoTech.languageManager.getRecipeDescriptionLore("calculator")));
