...
public class ParticleCollector extends AbstractProcessMachine implements EnergyNetComponent, RecipeDisplayItem {

    public ParticleCollector(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_PARTICLE_COLLECTOR";
    }
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        list.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescriptionTitle("particle_collector"), MomoTech.languageManager.getRecipeDescriptionLore("particle_collector")));
        list.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        list.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescriptionTitle("particle_collector.proton"), MomoTech.languageManager.getRecipeDescriptionLore("particle_collector.proton")));
        list.add(new SlimefunItemStack("MOMOTECH_PROTON", Items.MOMOTECH_PROTON));
        list.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescriptionTitle("particle_collector.zygote"), MomoTech.languageManager.getRecipeDescriptionLore("particle_collector.zygote")));
