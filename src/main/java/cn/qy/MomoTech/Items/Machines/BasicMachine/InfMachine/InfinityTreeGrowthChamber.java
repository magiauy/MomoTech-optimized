...
public class InfinityTreeGrowthChamber extends AbstractElectricGUI implements RecipeDisplayItem {
    ...
    public InfinityTreeGrowthChamber(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_INFINITY_TREE_GROWTH_CHAMBER";
    }
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        for (Material t : this.it) {
            it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, MomoTech.languageManager.getRecipeDescriptionTitle("supported_saplings"), MomoTech.languageManager.getRecipeDescriptionLore("supported_saplings")));
