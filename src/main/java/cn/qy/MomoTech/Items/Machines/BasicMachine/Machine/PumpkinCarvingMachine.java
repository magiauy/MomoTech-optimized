...
public class PumpkinCarvingMachine extends AbstractGUI implements RecipeDisplayItem {
    public PumpkinCarvingMachine(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_PUMPKIN_CARVING_MACHINE";
    }
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescriptionTitle("pumpkin_carving_machine"), MomoTech.languageManager.getRecipeDescriptionLore("pumpkin_carving_machine")));
