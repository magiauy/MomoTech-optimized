...
public class NoneConstructor extends AbstractGUI implements RecipeDisplayItem {
    public NoneConstructor(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_NONE_CONSTRUCTOR";
    }
    ...
    protected void findNextRecipe(BlockMenu inv) {
        ...
        if(pass){
            ...
            if(pass){
                inv.replaceExistingItem(getOutputSlots()[0],MomotechItem.none);
            }
        }
    }
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescriptionTitle("none_constructor"), MomoTech.languageManager.getRecipeDescriptionLore("none_constructor")));
        it.add(MomotechItem.none.clone());
        return it;
    }
}
