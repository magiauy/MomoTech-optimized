...
public class LightAndDarkCollector extends AbstractElectricGUI implements RecipeDisplayItem {
    public LightAndDarkCollector(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_LIGHT_AND_DARK_COLLECTOR";
    }
    ...
    public ItemStack outShine=new CustomItemStack(MomotechItem.light);
    public ItemStack outShell=new CustomItemStack(MomotechItem.nullItem);
    @Override
...
//        return false;
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        it.add(new CustomItemStack(Material.NETHERITE_PICKAXE, MomoTech.languageManager.getRecipeDescriptionTitle("light_and_dark_collector.light"), MomoTech.languageManager.getRecipeDescriptionLore("light_and_dark_collector.light")));
        it.add(MomotechItem.light.clone());
        it.add(new CustomItemStack(Material.NETHERITE_PICKAXE, MomoTech.languageManager.getRecipeDescriptionTitle("light_and_dark_collector.dark"), MomoTech.languageManager.getRecipeDescriptionLore("light_and_dark_collector.dark")));
