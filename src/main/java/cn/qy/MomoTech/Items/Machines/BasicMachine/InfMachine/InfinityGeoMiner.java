...
public class InfinityGeoMiner extends AbstractElectricGUI implements RecipeDisplayItem {

    public InfinityGeoMiner(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_INFINITY_GEO_MINER";
    }
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        it.add(new CustomItemStack(Material.NETHERITE_PICKAXE, MomoTech.languageManager.getRecipeDescriptionTitle("require_netherite_pickaxe"), MomoTech.languageManager.getRecipeDescriptionLore("require_netherite_pickaxe")));
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescriptionTitle("geo_miner"), MomoTech.languageManager.getRecipeDescriptionLore("geo_miner")));
        return it;
    }
}
