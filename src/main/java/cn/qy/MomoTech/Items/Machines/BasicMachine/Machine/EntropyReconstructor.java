...
public class EntropyReconstructor extends AContainer implements RecipeDisplayItem {
    public EntropyReconstructor(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_ENTROPY_RECONSTRUCTOR";
    }
