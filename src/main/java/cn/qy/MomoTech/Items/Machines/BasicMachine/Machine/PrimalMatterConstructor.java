...
public class PrimalMatterConstructor extends AbstractGUI implements RecipeDisplayItem {
    public PrimalMatterConstructor(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_PRIMAL_MATTER_CONSTRUCTOR";
    }
    ...
    public ItemStack outCreative1=new CustomItemStack(MomotechItem.primalMatterA);
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescriptionTitle("primal_matter_constructor.primal_matter_a"), MomoTech.languageManager.getRecipeDescriptionLore("primal_matter_constructor.primal_matter_a")));
        it.add(MomotechItem.primalMatterA.clone());
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescriptionTitle("primal_matter_constructor.primal_matter_b"), MomoTech.languageManager.getRecipeDescriptionLore("primal_matter_constructor.primal_matter_b")));
