...
public class InfinityMinerMineralBlock extends AbstractElectricGUI implements RecipeDisplayItem {
    ...
    public InfinityMinerMineralBlock(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_INFINITY_MINER_MINERAL_BLOCK";
    }
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        for (Material i : this.m) {
            it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, MomoTech.languageManager.getRecipeDescriptionTitle("possible_products"), MomoTech.languageManager.getRecipeDescriptionLore("possible_products")));
