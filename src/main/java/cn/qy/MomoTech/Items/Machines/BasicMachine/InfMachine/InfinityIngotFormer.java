...
public class InfinityIngotFormer extends AbstractGUI implements RecipeDisplayItem {
    public InfinityIngotFormer(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_INFINITY_INGOT_FORMER";
    }
...
//        }
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescriptionTitle("infinity_ingot_former"), MomoTech.languageManager.getRecipeDescriptionLore("infinity_ingot_former")));
