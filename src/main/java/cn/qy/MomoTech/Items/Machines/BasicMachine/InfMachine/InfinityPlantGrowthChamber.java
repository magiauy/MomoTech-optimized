...
public class InfinityPlantGrowthChamber extends AbstractElectricGUI implements RecipeDisplayItem {
    ...
    public InfinityPlantGrowthChamber(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_INFINITY_PLANT_GROWTH_CHAMBER";
    }
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        for (Material t : this.material) {
            it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, MomoTech.languageManager.getRecipeDescriptionTitle("supported_plants"), MomoTech.languageManager.getRecipeDescriptionLore("supported_plants")));
