...
public class NetheritePickaxeFactory extends AContainer implements RecipeDisplayItem {
    public NetheritePickaxeFactory(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public @NotNull String getMachineIdentifier() {
        return "MOMOTECH_NETHERITE_PICKAXE_FACTORY";
    }
