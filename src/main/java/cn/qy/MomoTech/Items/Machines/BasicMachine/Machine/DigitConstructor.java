...
public class DigitConstructor extends AbstractElectricGUI implements RecipeDisplayItem {
    public DigitConstructor(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getMachineIdentifier() {
        return "MOMOTECH_DIGIT_CONSTRUCTOR";
    }
    ...
    RandomizedItemStack digits=new RandomizedItemStack(new ArrayList<ItemStack>(){{
        for(int i=0;i<=10;++i){
            add(new CustomItemStack(MomotechItem.digit(i)));
        }
...
//        return false;
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        it.add(new CustomItemStack(Material.BOOK, MomoTech.languageManager.getRecipeDescriptionTitle("digit_constructor"), MomoTech.languageManager.getRecipeDescriptionLore("digit_constructor")));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        it.add(MomotechItem.nullItem.clone());
        it.add(MomotechItem.digit(10));
        return it;
    }
}
